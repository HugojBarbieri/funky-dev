...
import com.funkymonkeys.application.packageOrder.service.XLSService;
...
@RestController
@RequestMapping("/funky/package-xls")
public class PackageXLSResource {
    ...
    @Autowired
    public PackageXLSResource(XLSService xlsService, TiendaNubeService tiendaNubeService) {
    ...
    public ResponseEntity<byte[]> downloadExcel() {
        ...
        try {
            ...
            Workbook workbook = xlsService.getWorkbookFromOrders(tiendaNubeService.getUnpackagedOrders());
